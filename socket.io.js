...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="ad09b9cdd0d44037bc55861369e438aa" %>
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:32195190" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    ...
    <a role="menuitem" class="dropdown-item" href="/socketio/socket.io-client/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@Kgrzeskowiak" class="avatar float-left mr-1" src="https://avatars3.githubusercontent.com/u/32195190?s=40&amp;v=4" height="20" width="20">
    ...
    <details-dialog class="anim-fade-in fast Box Box--overlay" role="dialog" tabindex="-1">
      <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative flex-auto js-user-status-form" action="/users/status?compact=1&amp;link_mentions=0&amp;truncate=1" accept-charset="UTF-8" data-remote="true" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="rkntalw+cyUS2pVAQvuxjOdV9pw1LuFnotYQ29vK5xHJrPu4Y0Wpva5R0NB96FoiZk+pJ1Xv3uxPYOcd51ye8w==" />
        ...
        <div class="d-flex flex-items-center flex-justify-between p-3 border-top">
          ...
          <li><a role="menuitem" class="dropdown-item" href="/Kgrzeskowiak?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
    ...
    <div class="BtnGroup">
      ...
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/socketio/socket.io-client/commits/master/dist/socket.io.js">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
           href="x-github-client://openRepo/https://github.com/socketio/socket.io-client?branch=master&amp;filepath=dist%2Fsocket.io.js"
